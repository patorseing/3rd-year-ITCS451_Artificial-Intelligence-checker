	...
	*/
	public static void main(String[] args){
		...
		for(int i=0;i<args.length;i++){
			...
			//******************************************************************
			// YOU MUST MODIFY THIS SECTION TO USE YOUR LOGIN INSTEAD OF JDTRITZ
			// AND THEN UNCOMMENT IT.
			//******************************************************************
			
			else if(args[i].equals("-THAIPANICHPlayer")){
				if(redPlayer==null){
					redPlayer = new THAIPANICHPlayer("RED PLAYER");
				}else{
					blackPlayer = new THAIPANICHPlayer("BLACK PLAYER");
				}
			...
			else if(args[i].equals("-YupuechPlayer")){
				if(redPlayer==null){
					redPlayer = new YupuechPlayer("RED PLAYER");
				}else{
					blackPlayer = new YupuechPlayer("BLACK PLAYER");
				}
